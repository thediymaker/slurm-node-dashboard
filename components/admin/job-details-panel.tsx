// components/admin/job-details-panel.tsx
"use client";
...
export type JobDetailsPanelRef = {
  refreshData: () => void;
};

const JobDetailsPanel = forwardRef<JobDetailsPanelRef, JobDetailsPanelProps>(
  ({ jobId }, ref) => {
        ...
        if (result.status === 200 && result.data) {
          ...
          if (processedData.memoryUtilization.trend.length > 0) {
            processedData.memoryUtilization.max = Math.max(
              ...processedData.memoryUtilization.trend.map(
                (point) => point.value
              )
            );
          }
    ...
    // Removed auto-refresh that was in original code
                  ...
                  <div className="flex flex-col">
                    <div className="flex items-center justify-between">
                      <div className="space-y-1">
                        ...
                        <div
                          className={`text-2xl font-bold ${gpuStatus.color}`}
                        >
                  ...
                  <div className="flex flex-col">
                    <div className="flex items-center justify-between">
                      <div className="space-y-1">
                        ...
                        <div
                          className={`text-2xl font-bold ${memStatus.color}`}
                        >
                    ...
                    <div className="rounded-lg border border-yellow-800/30 bg-yellow-500/5 p-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground mt-1">
                            Your job shows moderate resource utilization.
                          ...
                          <ul className="mt-2 space-y-1 text-sm text-muted-foreground list-disc list-inside">
                            ...
                            <li>
                              Review model architecture for potential
                              bottlenecks
                            </li>
                          </ul>
                        </div>
...
JobDetailsPanel.displayName = "JobDetailsPanel";
